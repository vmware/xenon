...
public class GatewayApp {
    ...
    protected GatewayConfigHost configHost = null;
    protected GatewayDispatchHost dispatchHost = null;

    public static void main(String[] args) throws Throwable {
        GatewayAppArguments appArgs = new GatewayAppArguments();
        CommandLineArgumentParser.parse(appArgs, args);

        GatewayApp app = new GatewayApp();
        app.start(appArgs, null);
    ...
    public void start(GatewayAppArguments args, Consumer<Throwable> completionCallback) throws Throwable {
    ...
    protected void startDispatchHost(GatewayAppArguments args, Consumer<Throwable> completionCallback) {
        ...
        if (this.dispatchHost == null) {
            ...
            try {
                this.dispatchHost = new GatewayDispatchHost(this.configHost.getUri());
