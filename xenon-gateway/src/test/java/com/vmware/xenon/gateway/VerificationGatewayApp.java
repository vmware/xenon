...
import com.vmware.xenon.gateway.app.GatewayApp;
...
public class VerificationGatewayApp extends GatewayApp {
    ...
    private GatewayAppArguments arguments;
    private List<VerificationGatewayApp> peerGateways;
    private TestNodeGroupManager ngManager;

    public void startSynchronously(GatewayAppArguments args) throws Throwable {
