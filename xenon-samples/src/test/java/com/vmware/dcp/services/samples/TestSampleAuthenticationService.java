...
public class TestSampleAuthenticationService {
    ...
    private void testUnauthenticatedRequestRedirect(ServiceHost host) {
    ...
    private void testAccessTokenRequest(ServiceHost host) {
        TestRequestSender sender = new TestRequestSender(host);
    ...
    private void testTokenVerification(ServiceHost host) {
        TestRequestSender sender = new TestRequestSender(host);
