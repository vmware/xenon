...
public class TestSampleServiceWithCustomUi extends BasicReusableHostTestCase {
    ...
    public void testGetUi() throws Throwable {
        Operation op = Operation
                ...
                .setCompletion(guard((o, e) -> {
                    assertNull(e);
                    assertEquals(Operation.STATUS_CODE_MOVED_TEMP, o.getStatusCode());
                }));
    ...
    public void testGetUiWithSlash() throws Throwable {
        Operation op = Operation
                ...
                .setCompletion(guard((o, e) -> {
                    ...
                    assertTrue(o.getBody(String.class).contains("DOCTYPE"));
                }));
    ...
    public void testGetResource() throws Throwable {
        Operation op = Operation
                ...
                .setCompletion(guard((o, e) -> {
                    assertNull(e);
                    assertEquals(Operation.STATUS_CODE_OK, o.getStatusCode());
                    assertTrue(o.getBody(String.class).contains("unit-test"));
                }));
