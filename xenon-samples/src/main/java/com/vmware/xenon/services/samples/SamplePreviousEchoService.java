 ...
 */
public class SamplePreviousEchoService extends TypedStatefulService<SamplePreviousEchoService.EchoServiceState> {
     ...
     */
    @Override
    public CompletableFuture<EchoServiceState> handlePut(EchoServiceState state,
            EchoServiceState replacementState) {
     ...
     */
    @Override
    public CompletableFuture<EchoServiceState> handleGet(EchoServiceState state) {
        ...
        Operation startPost = Operation
                .createPost(uri)
                .setBody(task);
        return sendRequest(startPost, QueryTask.class)
                .thenApply(this::getPenultimate)
                .thenApply(penultimateState -> penultimateState != null ? penultimateState : state);
    }

    private EchoServiceState getPenultimate(QueryTask response) {
