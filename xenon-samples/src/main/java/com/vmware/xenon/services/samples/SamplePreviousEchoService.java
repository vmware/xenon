 ...
 */
public class SamplePreviousEchoService extends SimpleStateAwareRequestsHandler<SamplePreviousEchoService.EchoServiceState> {
     ...
     */
    @Override
    public Promise<EchoServiceState> handleGet(EchoServiceState state) {
        ...
        Request queryRequest = Operation
                .createPost(uri)
                .setBody(task);
        return sendRequest(queryRequest, QueryTask.class)
