...
public class XenonHost extends ServiceHost {
    ...
    static XenonHost startHost(String[] stringArgs, Arguments args) throws Throwable {
        XenonHost h = new XenonHost();
     ...
     * If you add new services, be sure to start them here - using either startService (for stateless) or
     * startFactory (for stateful)
     *
     * @return host
    ...
    public ServiceHost start() throws Throwable {
        ...
        // Optional : Xenon comes with a UI for browsing services, querying/etc.
        super.startService(new UiService());

        // For a stateful service, you need a factory that knows how to create instances of a service.
        // You will need a line like this for every stateful service that you create. The URL of the factory is defined
        // by the static variable FACTORY_LINK in the StatefulService class.
