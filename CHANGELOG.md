...
* Add `xenon.NettyHttpClientRequestHandler.includeAccessInfoInRequestLog` flag.
  When this parameter is set to true, the request log entry will contain `x-xenon-access-info` header value.
