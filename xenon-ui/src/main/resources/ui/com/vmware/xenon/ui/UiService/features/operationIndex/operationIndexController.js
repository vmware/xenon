...
angular.module('xenonDefault').controller('OperationIndexController', ['$scope', 'OperationIndexService',
    'UtilService',
        ...
        function getUrlsQuery() {
            ...
            var queryTask = {
                ...
                "querySpec": {
                    ...
                    "query": {
                        "term": {
                            "matchValue": "com:vmware:xenon:common:Operation:SerializedOperation",
