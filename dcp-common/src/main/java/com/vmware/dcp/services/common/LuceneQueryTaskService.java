    ...
    private void collectBroadcastQueryResults(Map<URI, String> jsonResponses, QueryTask queryTask) {
        ...
        if (!isPaginatedQuery) {
            ...
            URI broadcastPageServiceUri = UriUtils.buildUri(this.getHost(), UriUtils.buildUriPath(ServiceUriPaths.CORE,
                    "broadcast-query-page", String.valueOf(Utils.getNowMicrosUtc())));
            ...
            Operation startPost = Operation
                    ...
                    .setCompletion((o, e) -> {
                        if (e != null) {
                            failTask(new IllegalStateException("Failed to start [LuceneBroadcastQueryPageService] : " +
                                    e.getMessage()), o, null);
                            return;
                        }
            ...
            this.getHost().startService(startPost,
                    new LuceneBroadcastQueryPageService(queryTask.querySpec, nextPageLinks));
        }
