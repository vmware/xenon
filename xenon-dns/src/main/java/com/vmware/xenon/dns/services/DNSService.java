...
public class DNSService extends StatefulService {
    ...
    public static class DNSServiceState extends ServiceDocument {
        ...
        @UsageOption(option = ServiceDocumentDescription.PropertyUsageOption.AUTO_MERGE_IF_NOT_NULL)
        public Long healthCheckIntervalMicros;
        @UsageOption(option = ServiceDocumentDescription.PropertyUsageOption.AUTO_MERGE_IF_NOT_NULL)
    ...
    public void handleStart(Operation start) {
        ...
        if ( dnsServiceState.healthReference != null && dnsServiceState.healthCheckIntervalMicros != null ) {
            super.toggleOption(ServiceOption.PERIODIC_MAINTENANCE, true);
            setMaintenanceIntervalMicros(dnsServiceState.healthCheckIntervalMicros);
        }
    ...
    public void handlePatch(Operation patch) {
        ...
        if (currentState.healthReference != null && currentState.healthCheckIntervalMicros != null) {
            super.toggleOption(ServiceOption.PERIODIC_MAINTENANCE, true);
            setMaintenanceIntervalMicros(currentState.healthCheckIntervalMicros);
        } else {
