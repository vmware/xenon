...
public class TestResourceGroupService extends BasicReusableHostTestCase {
    ...
    public void testPatch() throws Throwable {
        ...
        PatchQueryRequest queryPatch = new PatchQueryRequest();
        queryPatch.clause = new Query();
        queryPatch.clause.setTermPropertyName("patch-name");
        queryPatch.clause.setTermMatchValue("patch-value");
        queryPatch.clause.setNumericRange(NumericRange.createEqualRange(1L));
        queryPatch.removeClause = false;
