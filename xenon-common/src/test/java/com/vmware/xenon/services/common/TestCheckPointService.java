...
public class TestCheckPointService extends BasicTestCase {
    ...
    public void checkPointBasedSynchronization() throws Throwable {
        ...
        verifySynchTask(lastUpdateExampleState.documentUpdateTimeMicros, 0);
    }
    ...
    private void verifySynchTask(long expectedCheckPoint, long expectedSynchCompletionCount) {
        ...
        this.host.waitFor("synch task finish timeout", () -> {
            ...
            if (!newState.checkPoint.equals(expectedCheckPoint)) {
                this.host.log(Level.INFO, "actual checkpoint %d, expected checkpoint %d", newState.checkPoint, expectedCheckPoint);
                return false;
            }
