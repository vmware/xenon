...
public class TestSimpleTransactionService extends BasicReusableHostTestCase {
    ...
    public void testHostRestartMidTransaction() throws Throwable {
        ...
        // restart host
        this.host.stopHostAndPreserveState(this.defaultHost);
        boolean restarted = VerificationHost.restartStatefulHost(this.defaultHost);
        assertTrue(restarted);
        setUpHostWithAdditionalServices(this.defaultHost);
