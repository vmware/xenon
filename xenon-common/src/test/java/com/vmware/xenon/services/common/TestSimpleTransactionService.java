...
public class TestSimpleTransactionService extends BasicReusableHostTestCase {
    ...
    static final String ACCOUNT_COUNT_PROP = "accountCount";
    public int accountCount = System.getProperty(ACCOUNT_COUNT_PROP) == null ? 20 :
            Integer.valueOf(System.getProperty(ACCOUNT_COUNT_PROP));
