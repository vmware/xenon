...
public class TestNodeGroupService {
    ...
    private void setUpLocalPeer(int nodeCount) throws Throwable {
    ...
    private void doReplication() throws Throwable {
        ...
        do {
            ...
            if (this.replicationFactor != 0) {
                nodeCount = (int)this.replicationFactor;
            }

            addNextPeer(remotePeerNodes, nodeCount, totalNodes);
            this.host.joinNodesAndVerifyConvergence(this.host.getPeerCount());
    ...
    private void addNextPeer(String[] peerNodes, int nodeCounter, int totalNodes) throws Throwable {
        if (nodeCounter > totalNodes) {
            return;
        }

        if (peerNodes == null) {
            setUpLocalPeer(nodeCounter);
        } else {
    ...
    private void cleanPeerNode(String[] peerNodes) throws Throwable {
        if (peerNodes == null) {
            return;
        }

        for (String peer : peerNodes) {
            this.host.deleteAllChildServices(UriUtils.buildUri(new URI(peer),
