...
public class TestNodeGroupService {
    ...
    public void synchronizationOneByOne() throws Throwable {
        ...
        stopHosts(exampleStatesPerSelfLink);
    }

    private void stopHosts(Map<String, ExampleServiceState> exampleStatesPerSelfLink)
            throws Throwable {
    ...
    @Ignore("https://www.pivotaltracker.com/story/show/114160081")
    @Test
    public void synchronizationManualWithDifferentNodeInitialState()
            throws Throwable {
