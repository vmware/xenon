...
public class TestCheckPointTaskService extends BasicTestCase {
    ...
    public void setUp(int nodeCount, String factoryLink) throws Throwable {
        ...
        if (this.host.getInProcessHostMap().isEmpty()) {
            ...
            for (VerificationHost host : this.host.getInProcessHostMap().values()) {
                ...
                if (factoryLink.equals(CustomExampleFactoryService.SELF_LINK)) {
    ...
    public void testTaskCreation() throws Throwable {
        setUp(this.nodeCount, ExampleService.FACTORY_LINK);
    ...
    public void verifyCheckPointWithNodeLeftThenJoin() throws Throwable {
        ...
        // node join
        setUpLocalPeerHost(ExampleService.FACTORY_LINK);
    ...
    public void verifyCheckPointWithNodeRestart() throws Throwable {
        ...
        restartHost(h0, ExampleService.FACTORY_LINK);
        this.host.joinNodesAndVerifyConvergence(this.nodeCount);
        this.host.waitForReplicatedFactoryChildServiceConvergence(
                this.host.getNodeGroupToFactoryMap(ExampleService.FACTORY_LINK),
                exampleStatesMap,
    ...
    public void verifyNodeLeftThenJoinSynchOnDemand() throws Throwable {
        ...
        String factoryLink = CustomExampleFactoryService.SELF_LINK;
        setUp(3, factoryLink);
        this.host.setNodeGroupQuorum(this.nodeCount - 1);
        this.host.waitForNodeGroupConvergence();

        List<ExampleServiceState> exampleStates =
                this.host.createExampleServices(this.host.getPeerHost(), this.serviceCount, null, factoryLink);
        ...
        // node join
        setUpLocalPeerHost(factoryLink);
        this.host.joinNodesAndVerifyConvergence(this.nodeCount);

        // more services after new node join
        exampleStates.addAll(this.host.createExampleServices(this.host.getPeerHost(), this.serviceCount, null, factoryLink));
    ...
    public void NodeSequentialJoinSynchOnDemand() throws Throwable {
        ...
        List<ExampleServiceState> exampleStates =
                this.host.createExampleServices(h0, this.serviceCount, null, factoryLink);
        Map<String, ExampleServiceState> exampleStatesMap = exampleStates.stream().collect(Collectors.toMap(s -> s.documentSelfLink, s -> s));
    ...
    private VerificationHost setUpLocalPeerHost(String factoryLink) throws Throwable {
    ...
    private VerificationHost restartHost(VerificationHost host, String factoryLink) throws Throwable {
        host.setPort(0);
