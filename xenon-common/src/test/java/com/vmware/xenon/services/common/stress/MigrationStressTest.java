 ...
 *
 * When this test is run by normal profile(e.g: "mvn test", from IDE), it uses in-process host with random port.
 * When run by "ci" profile, it is expecting host is running outside of the test process.
