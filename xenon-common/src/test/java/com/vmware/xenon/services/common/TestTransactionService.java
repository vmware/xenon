...
public class TestTransactionService extends BasicReusableHostTestCase {
    ...
    public void testSingleClientMultipleActiveTransactions() throws Throwable {
        ...
        for (int i = 0; i < this.accountCount; i++) {
            ...
            // deposit to every other account
            if (i % 2 == 0) {
        ...
        for (int i = 0; i < this.accountCount; i++) {
            // All transactions will have at least two pending ops-
            // creation and a get; accounts to which deposits were made will have
            // one more pending operation
            int pendingOps = 2;
            if (i % 2 == 0) {
                ++pendingOps;
            }
