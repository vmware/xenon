...
public class TestCheckpointService extends BasicTestCase {
    ...
    private static final int CHECKPOINT_QUERY_LIMIT = 1000;
    ...
    public static class CheckpointExampleService extends ExampleService {
        ...
        public static FactoryService createFactory() {
            ...
            fs.setCheckpointComparisonEpsilonMicros(CHECKPOINT_COMPARISON_EPSILON);
            fs.setCheckpointQueryLimit(CHECKPOINT_QUERY_LIMIT);
            return fs;
        }
