...
public class TestCheckpointService extends BasicTestCase {
    ...
    private static final long SYNCHRONIZATION_SCHEDULE_PERIOD = TimeUnit.MILLISECONDS.toMicros(1000);
    ...
    public void checkpointPerformance() throws Throwable {
        ...
        this.host.log("synch time cost %d seconds", TimeUnit.MICROSECONDS.toSeconds(Utils.getNowMicrosUtc() - start));
    }
