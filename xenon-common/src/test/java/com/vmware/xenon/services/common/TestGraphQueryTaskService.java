...
public class TestGraphQueryTaskService extends BasicTestCase {
    ...
    public void twoStageEmptyResults() throws Throwable {
        ...
        assertTrue(finalState.stages.get(0).results.queryTimeMicros > 0);
        // second stage should not even have run, since first stage had zero resilts
        assertTrue(finalState.stages.get(1).results == null);
        ...
        assertEquals(0L, (long) finalState.stages.get(0).results.documentCount);
