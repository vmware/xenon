...
public class TestUriUtils {
    ...
    public void testParseUriQueryParams() {
        URI u = UriUtils.buildUri("http://example.com:8000/?a=b&c=d&d&e=f=g&=z");
        ...
        assertTrue(queryParams.get("d") == null);
        assertTrue(queryParams.containsKey("d"));
        assertTrue(queryParams.get("e").equals("f=g"));
        assertTrue(queryParams.get("").equals("z"));
    }
}
