...
public class RunTestInContainer {
    ...
    public void setUp() throws Throwable {
        ...
        if (this.longRun) {
            this.host.setTimeoutSeconds(Integer.MAX_VALUE);
        } else {
    ...
    @Test
    public void nodeLeftThenJoinSyncInContainer() throws Throwable {
    ...
    @Test
    public void nodeRestartSyncInContainer() throws Throwable {
        this.host.setUpPeerHosts(this.nodeCount);
        this.host.joinNodesAndVerifyConvergence(this.nodeCount);
        this.host.setNodeGroupQuorum(this.nodeCount - 1);
        //create services
