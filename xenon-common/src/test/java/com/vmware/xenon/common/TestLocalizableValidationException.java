...
public class TestLocalizableValidationException extends BasicReusableHostTestCase {
    ...
    private static OperationProcessingChain constructFailingServiceOperationProcessingChain() {
        return OperationProcessingChain.construct(new Filter() {
            ...
            public FilterRC processRequest(Operation op, OperationProcessingContext context) {
                ...
                context.service.sendRequest(Operation.createGet(context.service,
