...
public class VerificationHost extends ExampleServiceHost {
    ...
    /**
     * Use built in Java synchronous HTTP client to verify XENON HttpListener is compliant
     */
