...
public class ExampleTest {
    ...
    private void test() throws Throwable {
        ...
        URI uri = UriUtils.buildUri(this.host, ExampleFactoryService.SELF_LINK);

        // create service
        Operation op = Operation.createPost(uri).setBody(state);
        ExampleState result = this.sender.sendAndWait(op, ExampleState.class);
        ...
        TestRequestSender.FailureResponse failure = this.sender.sendAndWaitFailure(op);
