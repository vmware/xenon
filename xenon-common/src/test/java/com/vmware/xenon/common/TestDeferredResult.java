...
public class TestDeferredResult {
    ...
    public void testApplyToEither() throws Throwable {
        verifyApplyToEither(1, 100);
        verifyApplyToEither(100, 1);
    }
    ...
    public void testAcceptEither() throws Throwable {
        verifyAcceptEither(1, 100);
        verifyAcceptEither(100, 1);
    }
    ...
    public void testRunAfterEither() throws Throwable {
        verifyRunAfterEither(1, 200);
        verifyRunAfterEither(200, 1);
    }
    ...
    public void testAnyOf() throws Throwable {
        ...
        IntStream.range(0, count).forEach(i -> {
            if (i == fastest) {
                ...
                runAfter(100, () -> deferredResults.get(i).complete(i));
            }
        });
        ctx.await();
