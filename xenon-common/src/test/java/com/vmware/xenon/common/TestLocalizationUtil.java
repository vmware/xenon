...
public class TestLocalizationUtil {
    ...
    public void testLocalizatioMessageResolution() {
        Operation op = Operation.createGet(URI.create("127.0.0.1")).setLocale("de,en-US;q=0.8,en;q=0.6");
    ...
    public void testResolveSecondaryLocaleMessage() {
        Operation op = Operation.createGet(URI.create("127.0.0.1")).setLocale("cn,en-GB;q=0.8,en;q=0.6");
    ...
    public void testResolveUnsupportedLocaleMessage() {
        Operation op = Operation.createGet(URI.create("127.0.0.1")).setLocale("cn");
