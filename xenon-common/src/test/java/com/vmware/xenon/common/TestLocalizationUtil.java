...
public class TestLocalizationUtil {
    ...
    @Before
    public void setUp() {
        this.ex = new LocalizableValidationException(SYSTEM_EX_MESSAGE, ERROR_MESSAGE_CODE, Arrays.asList(EX_ARG_VALUE));
    }
    ...
    public void testLocalizatioMessageResolution() {
        ...
        Assert.assertEquals(ERROR_MESSAGE_DE, message);
    }
    ...
    public void testResolveSecondaryLocaleMessage() {
        ...
        String message = LocalizationUtil.resolveMessage(this.ex, op);
        Assert.assertEquals(ERROR_MESSAGE_EN, message);
    }
    ...
    public void testResolveUnsupportedLocaleMessage() {
        ...
        Locale locale = LocalizationUtil.resolveLocale(op);
        Assert.assertEquals(LocalizationUtil.DEFAULT_LOCALE, locale);
    ...
    public void testMissingErrorCodeResolution() {
        this.ex = new LocalizableValidationException(SYSTEM_EX_MESSAGE, "missing.error.code", Arrays.asList(EX_ARG_VALUE));
        String message = LocalizationUtil.resolveMessage(this.ex, null);
        Assert.assertEquals(SYSTEM_EX_MESSAGE, message);
    }
}
