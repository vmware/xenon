...
import com.vmware.xenon.common.RequestRouter.Route.Documentation;
            ...
            try {
                ...
                if (doc != null) {
                    ...
                    if (doc.queryParams() != null) {
                        for (Documentation.QueryParam qp : doc.queryParams()) {
                    ...
                    if (doc.responses() != null) {
                        for (Documentation.ApiResponse response : doc.responses()) {
                            RequestRouter.Parameter p =
                                    new RequestRouter.Parameter(
