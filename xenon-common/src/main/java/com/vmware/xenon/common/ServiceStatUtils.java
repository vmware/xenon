...
public final class ServiceStatUtils {
    ...
    public static ServiceStat getOrCreateHourlyTimeSeriesStat(Service service, String name, EnumSet<AggregationType> aggregationTypes) {
        return getOrCreateStat(service, name, false, () -> createHourlyTimeSeriesStat(aggregationTypes));
    }

    public static ServiceStat getOrCreateDailyTimeSeriesStat(Service service, String name, EnumSet<AggregationType> aggregationTypes) {
        return getOrCreateStat(service, name, false, () -> createDailyTimeSeriesStat(aggregationTypes));
    }

    public static ServiceStat getOrCreateHourlyTimeSeriesHistogramStat(Service service, String name, EnumSet<AggregationType> aggregationTypes) {
        return getOrCreateStat(service, name, true, () -> createHourlyTimeSeriesStat(aggregationTypes));
    }

    public static ServiceStat getOrCreateDailyTimeSeriesHistogramStat(Service service, String name, EnumSet<AggregationType> aggregationTypes) {
        return getOrCreateStat(service, name, true, () -> createDailyTimeSeriesStat(aggregationTypes));
    }
