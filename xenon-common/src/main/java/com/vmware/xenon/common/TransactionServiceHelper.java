...
public class TransactionServiceHelper {
    ...
    static boolean handleOperationInTransaction(StatefulService s,
        ...
        if (request.getRequestHeader(Operation.VMWARE_DCP_TRANSACTION_HEADER).equals(Operation.TX_TRY_COMMIT) ||
                request.getRequestHeader(Operation.VMWARE_DCP_TRANSACTION_HEADER).equals(Operation.TX_ENSURE_COMMIT)) {
