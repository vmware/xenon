...
public class NettyHttpClientRequestHandler extends SimpleChannelInboundHandler<Object> {
    ...
    public static final String PROPERTY_NAME_ENABLE_SECURE_AUTH_COOKIE = PROPERTY_NAME_PREFIX +
            "DISABLE_SECURE_AUTH_COOKIE";

    public static final boolean ENABLE_SECURE_AUTH_COOKIE = Boolean.getBoolean(
            PROPERTY_NAME_ENABLE_SECURE_AUTH_COOKIE);
