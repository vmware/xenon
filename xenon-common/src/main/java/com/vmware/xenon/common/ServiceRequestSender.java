...
public interface ServiceRequestSender {
     ...
     * @return
     */
    default <T> DeferredResult<T> sendAsync(Operation op, Class<T> resultType) {
        return sendAsync(op)
     ...
     * @return
     */
    default DeferredResult<Operation> sendAsync(Operation op) {
        DeferredResult<Operation> promise = new DeferredResult<Operation>();
