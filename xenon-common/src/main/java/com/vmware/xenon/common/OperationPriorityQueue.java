...
public class OperationPriorityQueue {
    ...
    private static final class OperationComparator
            implements Serializable, Comparator<Operation> {
    ...
    private static OperationComparator COMPARATOR = new OperationComparator();
