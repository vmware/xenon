...
class ServiceResourceTracker {
    ...
    void createTimeSeriesStat(String name, double v) {
        ...
        ServiceStat dayStat = ServiceStatUtils.getOrCreateDailyTimeSeriesStat(service, dayStatName, types);
        ServiceStat hourStat = ServiceStatUtils.getOrCreateHourlyTimeSeriesHistogramStat(service, hourStatName, types);
