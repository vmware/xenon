...
class ServiceResourceTracker {
     ...
     */
    private Map<String, Service> attachedServices;

    /**
     * For performance reasons, this map is owned and directly operated by the host
     */
    private ConcurrentSkipListMap<String, Service> pendingPauseServices;
    ...
    public static ServiceResourceTracker create(ServiceHost host, Map<String, Service> services,
            ConcurrentSkipListMap<String, Service> pendingPauseServices) {
        ServiceResourceTracker sst = new ServiceResourceTracker();
        sst.host = host;
        sst.attachedServices = services;
        sst.pendingPauseServices = pendingPauseServices;
        return sst;
    }
