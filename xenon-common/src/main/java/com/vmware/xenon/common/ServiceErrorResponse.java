...
public class ServiceErrorResponse {
    ...
    public static final int ERROR_CODE_MASK = 0x80000000;
    ...
    private static boolean isBuiltInErrorCode(int errorCode) {
        return (errorCode & ERROR_CODE_MASK) != 0;
    }
    ...
    public void setErrorCode(int errorCode) {
        if (isBuiltInErrorCode(errorCode)) {
    ...
    public void setBuiltInCode(int errorCode) {
        if (!isBuiltInErrorCode(errorCode)) {
            throw new IllegalArgumentException(
