...
import com.vmware.xenon.services.common.AuthzCacheClearService.AuthzCacheClearServiceState;
...
public final class AuthorizationCacheUtils {
    ...
    public static void clearAuthzCacheForUser(Service s,  Operation op) {
        ...
        op.nestCompletion((o, e) -> {
            ...
            AuthzCacheClearServiceState cacheClearState = new AuthzCacheClearServiceState();
            cacheClearState.serviceLink = userPath;
            Operation postClearCacheRequest = Operation.createPatch(s.getHost(), ServiceUriPaths.CORE_AUTHZ_CLEAR)
