...
public final class XenonConfiguration {
    ...
    String getString(Class<?> subsystem, String property, String defaultValue) {
        ...
        if (v == null) {
            logUsingDefaultBecausetUnset(subsystem, property, defaultValue);
            return defaultValue;
        } else {
            return v;
        }
    ...
    long getDuration(Class<?> subsystem, String property, Duration defaultValue) {
        ...
        if (v == null) {
            logUsingDefaultBecausetUnset(subsystem, property, dv);
            return dv;
        }
    ...
    private void logUsingDefaultBecausetUnset(Object subsystem, String property, Object defaultValue) {
