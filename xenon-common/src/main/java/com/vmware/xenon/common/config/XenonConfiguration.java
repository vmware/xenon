...
public final class XenonConfiguration {
    ...
    private static final XenonConfiguration INSTANCE = new XenonConfiguration(new DefaultSource());
    ...
    double getDecimal(Class<?> subsystem, String property, double defaultValue) {
        String v = this.source.get(subsystem, property);

        if (v == null) {
            logUsingDefaulBecausetUnset(subsystem, property, defaultValue);
            return defaultValue;
        }
     ...
     * @return
     */
    public static long integer(Class<?> subsystem, String property, long defaultValue) {
    ...
    private void logUsingDefaulBecausetUnset(Object subsystem, String property, Object defaultValue) {
    ...
    private void logUsingDefaultBecauseBadValue(Class<?> subsystem, String property, Object defaultValue,
            String badValue) {
        if (logger.isLoggable(Level.FINE)) {
            logger.log(Level.FINE,
    ...
    long getDuration(Class<?> subsystem, String property, Duration defaultValue) {
        ...
        if (v == null) {
            logUsingDefaulBecausetUnset(subsystem, property, dv);
            return dv;
        }
