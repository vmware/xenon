...
public interface Service extends ServiceRequestSender {
    ...
    static final String STAT_NAME_SERVICE_PAUSE_COUNT = "globalPauseCount";
    static final String STAT_NAME_SERVICE_RESUME_COUNT = "globalResumeCount";
    static final String STAT_NAME_SERVICE_CACHE_CLEAR_COUNT = "globalCacheClearCount";
