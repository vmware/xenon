...
public interface Service extends ServiceRequestSender {
    ...
    static final String STAT_NAME_DOCUMENT_OWNER_TOGGLE_ON_COUNT = "maintenanceDocumentOwnerToggleOnCount";
    static final String STAT_NAME_DOCUMENT_OWNER_TOGGLE_OFF_COUNT = "maintenanceDocumentOwnerToggleOffCount";
