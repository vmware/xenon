...
public interface NodeSelectorService extends Service {
    ...
    int REPLICATION_TAG_CONNECTION_LIMIT = (int) XenonConfiguration.integer(
            NodeSelectorService.class,
            "REPLICATION_TAG_CONNECTION_LIMIT",
            32
    );

    int SYNCHRONIZATION_TAG_CONNECTION_LIMIT = (int) XenonConfiguration.integer(
            NodeSelectorService.class,
            "SYNCHRONIZATION_TAG_CONNECTION_LIMIT",
            32
    );

    int FORWARDING_TAG_CONNECTION_LIMIT = (int) XenonConfiguration.integer(
            NodeSelectorService.class,
