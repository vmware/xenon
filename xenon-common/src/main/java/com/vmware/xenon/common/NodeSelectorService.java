...
public interface NodeSelectorService extends Service {
     ...
     *
     * This method uses cached nodegroup state to calculate the owner; therefore, caller needs to make sure
     * the nodegroup state is stable before calling this method.
     */
