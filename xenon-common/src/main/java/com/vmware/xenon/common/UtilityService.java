...
public class UtilityService implements Service {
    ...
    public void setStat(ServiceStat stat, ServiceStat newValue) {
        synchronized (stat) {
    ...
    public void setStat(ServiceStat stat, double newValue) {
        ...
        synchronized (stat) {
            ...
            if (stat.timeSeriesStats != null) {
                stat.timeSeriesStats.setDataPoint(stat.lastUpdateMicrosUtc, newValue);
            }
        }
    }
    ...
    public void adjustStat(ServiceStat stat, double delta) {
        ...
        synchronized (stat) {
            ...
            stat.lastUpdateMicrosUtc = Utils.getNowMicrosUtc();
            if (stat.timeSeriesStats != null) {
                stat.timeSeriesStats.setDataPoint(stat.lastUpdateMicrosUtc, stat.latestValue);
            }
        }
    }
