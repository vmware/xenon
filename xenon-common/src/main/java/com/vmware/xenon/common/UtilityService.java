...
import com.vmware.xenon.services.common.AbstractUiService;
...
public class UtilityService implements Service {
    ...
    private AbstractUiService uiDelegate;
    ...
    private void handleUiRequest(Operation op) {
        ...
        if (this.uiDelegate == null) {
            this.uiDelegate = new AbstractUiService() {
            };
            this.uiDelegate.setHost(this.parent.getHost());
        }
        ...
        this.uiDelegate.handleUiGet(selfLink, this.parent, op);
    }
