...
public class SynchronizationTaskService
    ...
    private void handleQueryStage(State task) {
        ...
        Operation queryPost = Operation
                ...
                .setExpiration(
                        Utils.getExpirationTimeMicros(NodeGroupService.PEER_REQUEST_TIMEOUT_MICROS))
                .setCompletion((o, e) -> {
    ...
    private QueryTask buildChildQueryTask(State task) {
        ...
        queryTask.documentExpirationTimeMicros = Utils.getExpirationTimeMicros(timeoutMicros);
