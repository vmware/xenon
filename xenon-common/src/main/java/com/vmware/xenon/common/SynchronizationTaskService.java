...
public class SynchronizationTaskService
    ...
    public void handleStart(Operation post) {
        ...
        if (this.parent != null && this.parent.useCheckpoint()) {
                ...
                Operation.createPost(UriUtils.buildUri(getHost(), ServiceUriPaths.CHECKPOINT))
                        ...
                        .setCompletion((o, e) -> {
                            if (e != null) {
                                ...
                                setMaintenanceIntervalMicros(this.parent.getCheckpointPeriod());
                            }
    ...
    private QueryTask buildScanQueryTask(long prevMinCheckPoint) {
        QueryTask.NumericRange<Long> r =
                QueryTask.NumericRange.createLongRange(prevMinCheckPoint, Utils.getNowMicrosUtc() - this.parent.getCheckpointLag(),
                        false, true);
        ...
        return QueryTask.Builder.createDirectTask()
                .setQuery(q)
                .setResultLimit(this.parent.getCheckpointScanWindowSize())
