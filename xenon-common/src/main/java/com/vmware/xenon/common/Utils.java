...
public class Utils {
     ...
     */
    public static long getExpirationTimeMicros(long microsFromNow) {
        return getSystemNowMicrosUtc() + microsFromNow;
    }

    public static boolean isInThePast(long microsUtc) {
     ...
     * @return
     */
    public static long getNowMicrosUtc1() {
