...
/**
 * This filter forwards the operation to another host, if needed (e.g. if it
 * needs to be forwarded to the owner host).
 */
public class ForwardRequestFilter implements Filter {
    ...
    public FilterReturnCode processRequest(Operation op, OperationProcessingContext context) {
        ...
        // TODO: why can't we just rely on factory option OWNER_SELECTION?
        // (forward only if parent is a factory and has OWNER_SELECTION)
    ...
    private void selectAndForwardRequestToOwner(Service s, String path, Operation op,
        ...
        String nodeSelectorPath = parent != null ? nodeSelectorPath = parent.getPeerNodeSelectorPath() :
