...
public class NettyHttpServerInitializer extends ChannelInitializer<SocketChannel> {
    ...
    public static final String XENON_WEBSOCKET_HANDLER = "xenon_ws";
    ...
    public void initChannel(SocketChannel ch) {
        ...
        p.addLast(XENON_WEBSOCKET_HANDLER, new NettyWebSocketRequestHandler(this.host,
                ServiceUriPaths.CORE_WEB_SOCKET_ENDPOINT,
                ServiceUriPaths.WEB_SOCKET_SERVICE_PREFIX));
        p.addLast(XENON_HANDLER, new NettyHttpClientRequestHandler(this.host));
    }
}
