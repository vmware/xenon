...
public class Operation implements Cloneable {
    ...
    /**
     * Removes one or more request headers, skipping normalization
     */
    public Operation removeRequestHeaderAsIs(String... headers) {
        if (!hasRequestHeaders()) {
            return this;
        }
        for (String header : headers) {
            this.remoteCtx.requestHeaders.remove(header);
        }
        return this;
    }
