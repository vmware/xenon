...
public class Operation implements Cloneable {
    ...
    public static final String VMWARE_XENON_HEADER_NAME_PREFIX = "X-VMware-XENON-";
    public static final String CONTEXT_ID_HEADER = VMWARE_XENON_HEADER_NAME_PREFIX + "Context-Id";
    public static final String REQUEST_CALLBACK_LOCATION_HEADER = VMWARE_XENON_HEADER_NAME_PREFIX
            + "Request-Callback-Location";
    public static final String RESPONSE_CALLBACK_STATUS_HEADER = VMWARE_XENON_HEADER_NAME_PREFIX
            + "Response-Callback-Status";
    public static final String REQUEST_AUTH_TOKEN_HEADER = VMWARE_XENON_HEADER_NAME_PREFIX
            + "Auth-Token";
    public static final String ENTRY_NODE_HEADER = VMWARE_XENON_HEADER_NAME_PREFIX
            + "Entry-Node";
    public static final String REPLICATION_TARGET_HEADER = VMWARE_XENON_HEADER_NAME_PREFIX
            + "Replication-Target";
    public static final String REPLICATION_PHASE_HEADER = VMWARE_XENON_HEADER_NAME_PREFIX
            + "Replication-Phase";
    public static final String VMWARE_XENON_TRANSACTION_HEADER = VMWARE_XENON_HEADER_NAME_PREFIX
            + "Transaction-Phase";

    public static final String PRAGMA_DIRECTIVE_NO_QUEUING = "xenon-no-queuing";
    public static final String PRAGMA_DIRECTIVE_QUEUE_FOR_SERVICE_AVAILABILITY = "xenon-queue-for-service-availability";
    public static final String PRAGMA_DIRECTIVE_NO_FORWARDING = "xenon-no-forwarding";
    public static final String PRAGMA_DIRECTIVE_NOTIFICATION = "xenon-notification";
    public static final String PRAGMA_DIRECTIVE_SKIPPED_NOTIFICATIONS = "xenon-notifications-skipped";
    public static final String PRAGMA_DIRECTIVE_INDEX_CHECK = "xenon-check-index";
    public static final String PRAGMA_DIRECTIVE_VERSION_CHECK = "xenon-check-version";

    /**
     * Infrastructure use only. Instructs a persisted service to complete the operation but skip any index
     * updates.
     */
    public static final String PRAGMA_DIRECTIVE_NO_INDEX_UPDATE = "xenon-no-index-update";
