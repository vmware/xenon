...
public class Operation implements Cloneable {
    ...
    /**
     * Advance use. Prevents the request from getting queued, if a service is not yet available.
     */
    public static final String PRAGMA_DIRECTIVE_NO_QUEUING = "xn-no-queuing";

    /**
     * Advance use. Instructs the runtime to queue a request, for a service to become available
