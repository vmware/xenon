...
public class LocalFileService extends StatefulService {
    ...
    public enum FileType {
        ...
        /**
         * Only allow reading access to the local file.
         */
        READ_ONLY,

        /**
         * Provide write access to the local file.
         * If target file does not exist, it will be created upon receiving put request.
         */
        WRITE,

        /**
         * Open local file with {@link StandardOpenOption#APPEND}.
         */
        WRITE_APPEND,

        /**
         * Open local file with {@link StandardOpenOption#TRUNCATE_EXISTING}.
         */
        WRITE_OVERRIDE
    }
    ...
    public void handleStart(Operation start) {
        ...
        if (state.type == null) {
            start.fail(new IllegalStateException("type needs to be WRITE or READ_ONLY"));
            return;
        }
    ...
    public void handlePut(Operation put) {
        ...
        if (state.type == FileType.READ_ONLY) {
        ...
        if (state.type == FileType.WRITE_APPEND) {
            mode.add(StandardOpenOption.APPEND);
        } else if (state.type == FileType.WRITE_OVERRIDE) {
    ...
    public void handlePatch(Operation patch) {
        ...
        currentTask.writeProcessedBytes += patchBody.writeProcessedBytes;
