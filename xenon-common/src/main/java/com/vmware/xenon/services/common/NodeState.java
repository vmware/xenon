...
public class NodeState extends ServiceDocument {
    ...
    public static final String PROPERTY_NAME_DATACENTER = Utils.PROPERTY_NAME_PREFIX
            + "NodeState.datacenter";
    ...
    /**
     * Bag of additional properties, like {@link #PROPERTY_NAME_DATACENTER}
     */
