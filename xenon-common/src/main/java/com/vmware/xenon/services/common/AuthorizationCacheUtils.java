...
public class AuthorizationCacheUtils {
     ...
     */
    public static void nestClearAuthzCacheForUser(Service s, Operation op) {
     ...
     */
    public static void nestClearAuthzCacheForUserGroup(Service s, Operation op, UserGroupState userGroupState) {
     ...
     */
    public static void nestClearAuthzCacheForRole(Service s, Operation op, RoleState roleState) {
        ...
        op.nestCompletion((o, e) -> {
            ...
            Operation parentOp = Operation.createGet(s.getHost(), roleState.userGroupLink)
                    .setCompletion((getOp, getEx) -> {
                        ...
                        nestClearAuthzCacheForUserGroup(s, op, userGroupState);
                        op.complete();
                    });
     ...
     * @param op Operation to mark completion/failure
     */
    public static void nestClearAuthzCacheForResourceGroup(Service s, Operation op) {
            ...
            Operation postOp = Operation.createPost(s, ServiceUriPaths.CORE_LOCAL_QUERY_TASKS)
                    ...
                    .setCompletion((queryOp, queryEx) -> {
                        ...
                        for (Object doc : result.documents.values()) {
                            ...
                            nestClearAuthzCacheForRole(s, roleOp, roleState);
                            roleOp.complete();
                        }
                    }
                );
