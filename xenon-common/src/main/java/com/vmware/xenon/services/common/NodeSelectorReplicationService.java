...
public class NodeSelectorReplicationService extends StatelessService {
    ...
    /**
     * Returns the subset of nodes in the specified location
     */
     ...
     * operation based on the specified success threshold (0 means no threshold
     * is required and the original operation has already completed).
     */
