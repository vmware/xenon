 ...
 */
class PostgresIndexDocumentHelper {
    ...
    private static final boolean DISABLE_SORT_FIELD_NAMING = XenonConfiguration.bool(
            PostgresIndexDocumentHelper.class,
    ...
    public PostgresIndexDocumentHelper() {
    ...
    private void addIndexableFieldToDocument(Object podo, PropertyDescription pd,
        ...
        boolean isStored = fsv == Store.YES;
    ...
    private Field getAndSetStringField(String name, String value, Store fsv,
