...
public class QueryTask extends ServiceDocument {
    ...
    public static class Query {
        ...
        public Query removeBooleanClause(Query clause) {
            if (this.booleanClauses == null || clause == null) {
                return this;
            }
            this.booleanClauses.remove(clause);
            return this;
        }
        ...
        public boolean equals(Object obj) {
            if (obj != null && obj instanceof Query) {
                Query qObj = (Query)obj;
                if (Objects.equals(this.term, qObj.term)
                        && Objects.equals(this.occurance, qObj.occurance)
                        && Objects.equals(this.booleanClauses, qObj.booleanClauses)) {
                    return true;
                }
            }
            return false;
        ...
        @Override
        public int hashCode() {
            return Objects.hash(this.term, this.occurance, this.booleanClauses);
        }
    }
