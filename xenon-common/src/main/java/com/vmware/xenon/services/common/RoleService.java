    ...
    public static Service createFactory() {
        FactoryService fs = new FactoryService(RoleState.class) {
            ...
            public void handlePost(Operation request) {
                RoleState state = AuthorizationCacheUtils.extractBody(request, this, RoleState.class);
                System.out.println("Invoking role creation for :" + state.documentSelfLink + "; at :" + Utils.getNowMicrosUtc());
