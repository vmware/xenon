...
public class NodeGroupUtils {
    ...
    /**
     * Convert {@link NodeGroupBroadcastResponse} to {@link BroadcastResponse}
     */
    public static BroadcastResponse toBroadcastResponse(NodeGroupBroadcastResponse response) {
        ...
        for (Entry<URI, String> entry : response.jsonResponses.entrySet()) {
            BroadcastSingleResponse singleResult = new BroadcastSingleResponse();
