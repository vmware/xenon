...
public class NodeGroupUtils {
    ...
    /**
     * Complete operation when target service for the given path became available in node group
     *
     * @see ServiceHost#registerForServiceAvailability(Operation, boolean, String...)
