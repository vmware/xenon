...
public class ServiceHostManagementService extends StatefulService {
    ...
    public static class BackupRequest {
         ...
         *
         * Currently, http/https scheme and file scheme with local file are supported.
    ...
    private URI createLocalFileServiceUri() {
        String servicePath = UriUtils.buildUriPath(LocalFileService.SERVICE_PREFIX, getHost().nextUUID());
        return UriUtils.buildUri(getHost(), servicePath);
    }
