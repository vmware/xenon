...
public class ServiceHostManagementService extends StatefulService {
    ...
    public static class BackupRequest {
        ...
        /**
         * Target path to the document index backup service
         */
        public String documentBackUpServicePath = ServiceUriPaths.CORE_DOCUMENT_INDEX_BACKUP;
    }
    ...
    private void handleBackupRequest(BackupRequest req, Operation op) {
        ...
        Operation patch = Operation.createPatch(this, req.documentBackUpServicePath)
