    ...
    public ServiceHost start() throws Throwable {
        ...
        if (this.args != null) {
            if (this.args.adminUser != null) {
                ...
                String sourceNodeGroup = System.getProperty("sourceNodeGroupUri");
                ...
                if (sourceNodeGroup != null && !sourceNodeGroup.trim().equals("")) {
                    log(Level.INFO, "Starting up in upgrade mode! Migrate state from [sourceNodeGroup=%s]", sourceNodeGroup);
                    ...
                    Operation postForAuth = Operation.createPost(this, BasicAuthenticationService.SELF_LINK)
                            .setBody(authRequest)
                            ...
                            .setCompletion((op, err) -> {
                                ...
                                state.sourceNodeGroupReference = UriUtils.buildUri(sourceNodeGroup);
