...
public class ExampleTaskService
        extends AbstractTaskService<ExampleTaskService.ExampleTaskServiceState> {
    ...
    public static class ExampleTaskServiceState extends AbstractTaskService.BaseTaskServiceState {
