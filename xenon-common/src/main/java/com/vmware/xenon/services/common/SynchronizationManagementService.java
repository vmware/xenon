 ...
 *    3.  Check factory synchronization task's status from the factory owner node for determining if it is SYNCHING.
 *
    ...
    private DeferredResult<Object> getSynchronizationTaskStatus(
        ...
        synchTaskGet.setCompletion((o, e) -> {
            ...
            if (s.taskInfo.stage == TaskState.TaskStage.STARTED &&
                ...
                factoryState.status = SynchronizationManagementState.Status.SYNCHING;
            }
            synchronizationTask.complete(null);
