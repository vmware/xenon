...
public class AuthorizationContextService extends StatelessService {
    ...
    private boolean checkIfUSerStateAndLoadUserGroups(AuthorizationContext ctx, Claims claims, ServiceDocument userServiceDocument) {
    ...
    private void loadUserGroups(AuthorizationContext ctx, Claims claims, ServiceDocument userServiceDocument) {
        ...
        if (checkIfUSerStateAndLoadUserGroups(ctx, claims, userServiceDocument)) {
            return;
        }
