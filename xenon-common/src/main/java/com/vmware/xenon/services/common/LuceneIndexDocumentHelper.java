...
class LuceneIndexDocumentHelper {
    public static final String NUMERIC_PROPERTY_GROUP = "_group";
    ...
    void addNumericField(String propertyName, long propertyValue,
        ...
        if (sorted) {
            ...
            Field sdField = getAndSetSortedStoredField(propertyName + NUMERIC_PROPERTY_GROUP,
    ...
    private void addIndexableFieldToDocument(Object podo, PropertyDescription pd,
        ...
        if (v instanceof String) {
            ...
            // special handling for sorted numeric fields
