...
class LuceneIndexDocumentHelper {
    ...
    void addVersionField(long version) {
        setThreadLocalFields(this.doc, version, this.versionField);
    }

    void addUpdateTimeField(long updateTimeMicros) {
        setThreadLocalFields(this.doc, updateTimeMicros, this.updateTimeField);
    }

    void addExpirationTimeField(long exp) {
        setThreadLocalFields(this.doc, exp, this.expirationTimeField);
    }

    private void setThreadLocalFields(Document doc, long value, LongFieldContext ctx) {
