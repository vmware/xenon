 ...
 * a SELF_LINK static field for the prefered uri. This service will behave like a web server
 * serving files from a directory.
 */
public abstract class AbstractUiService extends StatelessService {
    public AbstractUiService() {
