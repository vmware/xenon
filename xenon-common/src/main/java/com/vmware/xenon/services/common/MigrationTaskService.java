...
public class MigrationTaskService extends StatefulService {
    ...
    public static final String STATS_PROCESSED_DOCUMENTS = "PROCESSED_DOCUMENTS";
    public static final String STATS_ESTIMATED_TOTAL_SERVICE_COUNT = "ESTIMATED_TOTAL_SERVICE_COUNT";
    ...
    private void computeFirstCurrentPageLinks(State currentState, List<URI> sourceURIs, List<URI> destinationURIs) {
        ...
        OperationJoin.create(queryOps)
            .setCompletion((os, ts) -> {
                ...
                adjustStat(STATS_ESTIMATED_TOTAL_SERVICE_COUNT, estimatedTotalServiceCount);
    ...
    private void migrateEntities(Map<Object, String> json, State state, Set<URI> nextPageLinks, List<URI> destinationURIs, Map<String, Long> lastUpdateTimesPerOwner) {
        ...
        OperationJoin.create(posts)
            .setCompletion((os, ts) -> {
                ...
                adjustStat(STATS_PROCESSED_DOCUMENTS, posts.size());
