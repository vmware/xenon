...
public class ExampleFooService extends StatefulService {
    public static final String FACTORY_LINK = ServiceUriPaths.CORE + "/foo";

    public static class ExampleFooState extends ServiceDocument {
